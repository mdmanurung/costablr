...
static const R_CallMethodDef CallEntries[] = {
    {"_stablr_wls_exp", (DL_FUNC) &_stablr_wls_exp, 28},
    {"_stablr_spwls_exp", (DL_FUNC) &_stablr_spwls_exp, 30},
    {NULL, NULL, 0}
};

RcppExport void R_init_stablr(DllInfo *dll) {
