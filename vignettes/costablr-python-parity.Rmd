...
knitr::opts_chunk$set(
  ...
  fig.height = 5,
  cache      = TRUE,
  cache.path = "costablr-python-parity-cache/"
)
```
...
run_extended <- identical(
  tolower(Sys.getenv("COSTABLR_RUN_EXTENDED_VIGNETTES", "false")),
  "true"
)
```
...
lambda values, and random-permutation artificial features when
`COSTABLR_RUN_EXTENDED_VIGNETTES=true`, matching the notebook's default STABL
classifier settings.
