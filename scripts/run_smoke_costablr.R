...
if (is.null(repo_root)) {
  stop("Could not resolve costablr package root containing DESCRIPTION and R/.",
       call. = FALSE)
}
...
cat("costablr smoke benchmark completed\n")
