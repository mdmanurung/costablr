...
# Run from repo root: Rscript r-pkg/stablr/scripts/port_multiview.R
...
src_pkg <- file.path(repo_root, "third_party", "multiview", "R")
dest <- file.path(repo_root, "r-pkg", "stablr", "R", "cooperative", "vendored")
